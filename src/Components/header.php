...
<head>
  ...
  <title>Simon Malpel - Portfolio</title>
  <meta content="Portfolio of Simon Malpel" name="descriptison">
  <meta content="Simon Malpel, Portfolio, CV, Malpel" name="keywords">
...
<body>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Lua <i class="val">100%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">JavaScript (Cordova, NodeJs) <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Debian / Ubuntu / Centos <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Windows Server <i class="val">85%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">OpenStack <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Kubernetes <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
        ...
        <p class="text-justify mt-5">
          Les pourcentages représentent mon niveau de connaissance globale sur une ou plusieurs thématiques.
          Cependant l'apprentissage dans ce domaine ne cesse jamais, c'est pourquoi même si pour centaines le niveau est à 100% je continue de m'investir et d'augmenter mes connaissances.
        </p>
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <ul>
                ...
                <li>Intégration et configuration du progiciel sur un Raspberry PI.</li>
                <li>Installation du service chez le client</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Stage en entreprise</h4>
    ...
    <!-- ======= Services Section ======= -->
    <section id="learning-places" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="https://stackoverflow.com/">Stack Overflow</a></h4>
              <p>L'ami incontournable de n'importe quel développeur, il n'est plus à présenter !</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <h4><a href="https://www.developpez.net/">developpez.net</a></h4>
              <p>Quand Stack Overflow est en panne il est important d'assurer ses arrières...</p>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contactez moi</h2>
          <p>Des questions sur mon passé ou des propositions pour mon avenir?</p>
        </div>
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Adresse:</h4>
                <p>7 Boulevard Joliot Curie,<br /> 44200 - Nantes, France</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>simon.malpel@orange.fr</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Veuillez écrire quelque chose ici" placeholder="Message"></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
